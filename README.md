...
* [neocomplete](https://github.com/Shougo/neocomplete.vim)- Ultimate auto completion system for Vim.
...
* [nerdtree-ack](https://github.com/tyok/nerdtree-ack)- Add capability to search in folders via NERDtree. 
